 ...
 * @参数       @参数 @参数
 */
function Alipay_wap($paytypeArr,$param)
{
    if ($paytypeArr['paytype'] == 'alipay_wap') {

        $config['app_id'] = $paytypeArr['store_name']; //商户标识
        $config['merchant_private_key'] = $paytypeArr['store_key']; //商户秘钥
        $config['alipay_public_key'] = $paytypeArr['store_key2']; //商户公钥
