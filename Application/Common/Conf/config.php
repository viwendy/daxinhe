...
//***********************************短信相关配置**********************************
    'SMS_TYPE'               => 1,  //短信方式 短信宝 1  阿里云2 聚合短信 3
    'SMS_BAO'                =>array(
        'user'               => 'dashixiong888',  // 短信宝 用户名 smsbao.com
        'password'           => '123qwe',  // 短信宝 密码
        'sign'               => '云淘淘',          //短信宝 签名 【臻赞】您的验证码为{$code}，验证码5分钟内有效。";
    ),
    'SMS_ALISMS'             =>array(
...
//***********************************缓存设置**********************************
    ...
    'WEIXINPAY_CONFIG'       => array(
        ...
        'MCHID'              => '1550951', // 微信支付MCHID 商户收款账号
        'KEY'                => 'Vw8n8o44nPl', // 微信支付KEY
        'APPSECRET'          => '486c5bbfb442e',  //公众帐号secert
    ...
    'VERSION'      => '20191127',     //加入版本号 为了更加方便的更新升级
);
