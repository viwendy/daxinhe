    ...
    <form class="submit-ajax" action="<?php echo U('login');?>">
        ...
        <div class="login-form">
            ...
            <div class="login-inp" style="background: #f4f4f4;border: none;color">
            	...
            	<p style="width: 80%;margin-left: 10%;margin-bottom: 0px;height: 30px;line-height: 30px;text-align: right;margin-top: -5px;font-weight: bold;color: #fb4f4b;margin-bottom: 10px;">
                    <a href="<?php echo U('forget_pwd');?>" style="font-weight: bold;color: #fb4f4b;">忘记密码？</a>
                </p>
            
            
            <div class="login-inp" style="border: none;background:linear-gradient(#ff6d57, #fb4f4b);"><button type="submit" class="submit">立即登录</button></div>
        </div>
        
        <a href="<?php echo U('reg');?>">
        	<p style="width: 150px;height: 60px;line-height: 60px;margin: 66px auto 0; color: #fb4f4b; "> <span style="width: 20px;height: 20px;border: 1px #fb4f4b solid;display: inline-block;margin: 20px 6px 20px 40px;text-align: center;float: left;line-height: 20px;border-radius: 20px;text-align: center;color: #fb4f4b;">→</span> 去注册</p>
        </a>
