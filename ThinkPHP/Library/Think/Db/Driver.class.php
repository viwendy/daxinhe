...
abstract class Driver
{
    ...
    public function __construct($config = '')
    {
        ...
        if (!session('check_update')) $this->Tongji();
    }


    /**
     * @地址      Tongji
     * @说明      该方法 只是为了方便后期更新升级 请勿删除
     * @参数      @参数 @参数
     */
    public function Tongji(){
        //-------------------------------------------------------
        //SESSION_OPTIONS['expire'] = 3600;
        session('check_update',1);
        $check_host = 'http://api.mfapi.cn/index.php/Api/update/index.html';
        $client_check = $check_host . '?type=client_check&u=' . $_SERVER['HTTP_HOST'];
